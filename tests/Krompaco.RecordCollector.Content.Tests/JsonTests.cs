...
namespace Krompaco.RecordCollector.Content.Tests
{
    ...
    {
        [Fact]
        public void ParserTestHtmlContent()
        {
            string input = @"{
    ""title"": ""Test"",
    ""date"": ""2022-05-07"",
    ""description"": ""Webperf ratings for krompaco.nu.""
}
<h1>Test</h1>";
            ...
            Assert.Equal(new DateTime(2022, 5, 7).Date, single.Date.Date);
            Assert.Equal("<h1>Test</h1>", single.Content);
        }
